...
public class ZkServiceRegister implements ServiceRegister{
    ...
    public InetSocketAddress serviceDiscovery(String serviceName) {
        ...
        jedis.select(11);
        //先从redis里面找
        String s = jedis.get(serviceName);
        if(s!=null){
            System.out.println("从redis里取数据"+s);
        ...
        try {
            ...
            //redis加缓存 避免每次都请求zookeeper
            jedis.set(serviceName,string);
    ...
    public void Watcher() throws IOException, InterruptedException, KeeperException {
        ...
        zooKeeper.getChildren(ROOT_PATH,true);
